...
pipeline {
    ...
    parameters {
        ...
        string(name: 'IMAGE_NAME', defaultValue: 'stacktonic/nginx', description: 'How should I store the image?')
...
'''
    ...
    stages {
        stage('Get Code') {
            steps {
                git branch:'main', url: 'https://github.com/StackTonic/docker-nginx.git'
            }
        }
